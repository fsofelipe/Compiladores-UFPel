class Parser{
    ...
    ArvoreSintatica parseProg() throws Exception {
        ArvoreSintatica resultado = Exp(); // Exp = Metodo
    ...
    Exp Exp() throws Exception{
        ...
        //System.out.println("Parser->Exp | Usando: " + tokenCorrente.lexema + " - " + tokenCorrente.token.toString());

        if(tokenCorrente.token == TokenType.NUM){

            return new Num(tokenCorrente.num);
        }
